...
const Footer = () => {
  return (
    <footer>
      ...
      <div className=" w-full flex flex-col md:flex-row py-20 px-8 md:px-10 gap-10 lg:gap-20">
        <p className=" text-lg text-white font-semibold">
          Address 70-10100,Nyeri
        </p>
        <div className=" flex flex-col justify-center items-center md:flex-row text-md gap-5 md:gap-20 text-white">
          <a href="#home">Home</a>
      ...
      <div className="flex flex-col gap-10 items-center justify-center pb-20">
        ...
        <p className=" text-gray-400 text-md tracking-wider">@2023 Eric Njuguna</p>
      </div>
    </footer>
  );
};
