...
function App() {
  ...
  return (
    ...
    >
      <div className="w-ful h-full min-h-[100vh] bg-white">
        <div className="dark:bg-gradient-to-r from-[#0235a3] via-[#030a1c] to-[#05174e]">
          <Navbar
            darkMode={darkMode}
            isOpen={isOpen}
        ...
        <section id="contactme" className=" w-full px-0 lg:px-5 2xl:px-40 py-10 lg:py-0 dark:bg-[radial-gradient(ellipse_at_top_left,_var(--tw-gradient-stops))] from-[#030a1c] to-[#05174e]">
          <ContactMe/>
